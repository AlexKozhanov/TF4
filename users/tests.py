...
class UserTest(APITestCase):
    """
    Тестирование CRUD операций User.
    """
    def setUp(self):
    ...
    def test_list_users(self):
        """
        Тест вывод списка пользователей.
        """
        url = reverse("users:user-list")
    ...
    def test_retrieve_users(self):
        """
        Тест просмотр данных пользователя.
        """
    ...
    def test_update_user(self):
        """
        Тест изменения данных пользователея.
        """
        url = reverse(
            "users:user-detail", args=(self.user.pk,))
