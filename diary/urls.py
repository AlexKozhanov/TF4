...
from diary.views import (
    Home, Contacts, DiaryListView, DiaryDetailListView, DiaryCreateView, DiaryUpdateView, DiaryDeleteView,
    DiaryEntriesListView, DiaryEntriesDetailListView, DiaryEntriesCreateView, DiaryEntriesUpdateView)
