...
class DiaryListView(LoginRequiredMixin, ListView):
    model = Diary
    template_name = 'diary/product_list.html'
...
class DiaryDetailListView(LoginRequiredMixin, DetailView):
    ...
    template_name = 'diary/product_detail.html'
...
class DiaryCreateView(LoginRequiredMixin, CreateView):
    model = Diary
    form_class = DiaryForm
    template_name = 'diary/product_form.html'
    success_url = reverse_lazy('diary:product_list')
...
class DiaryUpdateView(LoginRequiredMixin, UpdateView):
    ...
    def get_success_url(self):
        return reverse('diary:product_detail', args=[self.kwargs.get('pk')])
...
class DiaryDeleteView(LoginRequiredMixin, DeleteView):
    model = Diary
    template_name = 'diary/product_delete.html'
    success_url = reverse_lazy('diary:product_list')
...
class DiaryEntriesListView(LoginRequiredMixin, ListView):
    model = DiaryEntries
    template_name = 'diary/category_list.html'
...
class DiaryEntriesDetailListView(LoginRequiredMixin, DetailView):
    model = DiaryEntries
    template_name = 'diary/category_detail.html'
    success_url = reverse_lazy('diary:category_list')
...
class DiaryEntriesCreateView(LoginRequiredMixin, CreateView):
    ...
    template_name = 'diary/category_form.html'
    success_url = reverse_lazy('diary:category_list')
...
class DiaryEntriesDeleteView(LoginRequiredMixin, DeleteView):
    model = DiaryEntries
    template_name = 'diary/category_delete.html'
    success_url = reverse_lazy('diary:product_list')
    # permission_required = 'diary.delete_product'
